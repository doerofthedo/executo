<template>
    <AuthLayout panel-class="max-w-[28rem]">
        <div class="mx-auto w-full max-w-[24rem]">
            ...
            <div class="mt-4 flex flex-wrap items-center justify-center gap-2 border-t border-[var(--lex-border)] pt-4">
                <span class="text-[0.6875rem] font-semibold uppercase tracking-[0.14em] text-[var(--lex-muted)]">{{ t('auth.locale.label') }}</span>
                <button
                    type="button"
...
const fieldLabelClass = 'text-[0.6875rem] font-semibold uppercase tracking-[0.1em] text-[var(--lex-muted)]';
const inputClass = 'w-full rounded-sm border border-[var(--lex-border-strong)] bg-white px-4 py-3 text-[var(--lex-text)] outline-none transition focus:border-[var(--lex-accent)] focus:shadow-[0_0_0_3px_rgba(36,65,107,0.08)]';
const primaryButtonClass = 'inline-flex min-h-12 cursor-pointer items-center justify-center rounded-sm bg-[var(--lex-accent)] px-4 py-3 text-center text-sm font-semibold leading-[1.25rem] text-white shadow-[0_10px_18px_rgba(36,65,107,0.12)] transition hover:-translate-y-px hover:bg-[var(--lex-accent-hover)] hover:shadow-[0_14px_24px_rgba(27,51,85,0.18)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--lex-accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-white active:translate-y-px disabled:cursor-not-allowed disabled:opacity-70 disabled:hover:translate-y-0 disabled:hover:shadow-[0_10px_18px_rgba(36,65,107,0.12)]';
const secondaryButtonClass = 'inline-flex min-h-12 cursor-pointer items-center justify-center rounded-sm border border-[var(--lex-secondary-border)] bg-[var(--lex-secondary-surface)] px-4 py-3 text-center text-sm font-semibold leading-[1.25rem] text-[var(--lex-secondary-text)] shadow-[0_8px_16px_rgba(31,42,55,0.06)] transition hover:-translate-y-px hover:border-[var(--lex-secondary-border)] hover:bg-[var(--lex-secondary-surface-hover)] hover:shadow-[0_12px_22px_rgba(31,42,55,0.1)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--lex-accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-white active:translate-y-px';
function inlineButtonClass(value: 'lv' | 'en'): string {
    const base = 'inline-flex min-h-9 cursor-pointer items-center justify-center rounded-sm border px-3 py-2 text-sm font-medium leading-[1.25rem] transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--lex-accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-white active:translate-y-px';
